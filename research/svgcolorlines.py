...
for i in range(0,len(aListInt)-2,5):
	d.append(draw.Line(aListInt[i], 256-aListInt[i+1], aListInt[i+5], 256-aListInt[i+6],stroke=getHexFunction(aListInt[i+2],aListInt[i+3],aListInt[i+4]), stroke_width=2))
